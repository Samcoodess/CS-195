...
player1_board=[]
player2_board=[]
player1_board_space = set()
player2_board_space = set()
...
# while winner not in player1_board_space or winner not in player2_board_space:
for i in range(1,10):
